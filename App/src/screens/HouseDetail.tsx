 ...
 * straight to PersonProfile — this screen still handles that case too, defensively. Private
 * residents are also routed here instead of PersonProfile, since tapping their house pin
 * would otherwise reveal exactly which address/identity pair they're trying to keep hidden. */
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {resident?.isPrivate ? (
          <View style={styles.emptyCard}>
            <Lock size={30} color={theme.colors.inkSoft} />
            <Text style={[styles.emptyTitle, { marginTop: 12 }]}>This person's account is private.</Text>
            <Text style={styles.emptyBody}>They've chosen to keep their name and address hidden from the map. You can still find neighbors by name in the Yellow Pages.</Text>
          </View>
        ) : resident ? (
