...
export type AlertDismissalRow = { alert_id: string; profile_id: string; dismissed_at: string };
...
export type ModerationLogRow = {
  ...
  community_id: string;
  board_profile_id: string | null;
  entity_type: 'club_post' | 'event' | 'community_spot' | 'ask' | 'community_post' | 'poll' | 'business' | 'alert';
  summary: string;
  created_at: string;
};
...
export type Database = {
  public: {
    Tables: {
      ...
      businesses: Rows<BusinessRow>;
      business_ratings: Rows<BusinessRatingRow>;
      alerts: Rows<AlertRow>;
      alert_dismissals: Rows<AlertDismissalRow>;
    };
    ...
    Functions: {
      ...
      moderate_delete_business: { Args: { p_business_id: string }; Returns: void };
      moderate_delete_alert: { Args: { p_alert_id: string }; Returns: void };
    };
